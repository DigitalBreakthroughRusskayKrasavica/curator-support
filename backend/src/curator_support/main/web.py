...
from curator_support.presentation.web.app_setup import (
    create_app,
    create_http_server,
    initialise_dependencies,
    initialise_routers,
)
from curator_support.presentation.web.config import load_web_config
...
async def main() -> None:
    ...
    config = load_web_config(os.getenv("CURATOR_SUPPORT_CONFIG_PATH") or DEFAULT_CONFIG_PATH)
