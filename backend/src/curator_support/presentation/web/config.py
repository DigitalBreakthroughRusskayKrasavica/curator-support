...
from curator_support.config import DbConfig, HttpServerConfig

DEFAULT_APP_TITLE: str = "curator_support"
DEFAULT_APP_DESCRIPTION: str = "Server part of the curator_support."
